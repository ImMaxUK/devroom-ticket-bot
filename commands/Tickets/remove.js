...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('remove')
		.setDescription('Removes the specified user from the ticket.')
	...
	async execute(interaction) {
		...
		interaction.channel.permissionOverwrites.create(interaction.options.getMentionable('user'), { VIEW_CHANNEL: false } )

		interaction.reply({
			embeds: [primaryEmbed('', 'Removed the user from the ticket!')],
		})    }
}